...
namespace RPGCharacterAnims
{
    public class RPGCharacterController:MonoBehaviour
    {
        ...
        public spearSlot spearS;
        public tht throwa;
        public tht throwaLeg;
        ...
        private void Update()
        {
			...
			{
				if (Input.GetKeyDown(KeyCode.Mouse0) && grab.collided)
                {
                    if (once)
                    {
                        stopFall = true;
                ...
                if (Input.GetKeyUp(KeyCode.Mouse0))
                {
                    ...
                    //Vector3 directionVector = (this.gameObject.transform.position - this.gameObject.GetComponent<hitReceive>().go).normalized;
                    //this.gameObject.GetComponent<Rigidbody>().AddForce(this.transform.forward * Kamount, ForceMode.Impulse);
                }
            ...
            //if (playa1)
            //{
            //    if (this.gameObject.GetComponent<hitReceive>().isHit)
            //    {
            //        print("knock!");
            //        this.gameObject.GetComponent<Rigidbody>().isKinematic = false;
            //        Vector3 directionVector = (this.gameObject.transform.position - this.gameObject.GetComponent<hitReceive>().go).normalized;
            //        this.gameObject.GetComponent<Rigidbody>().AddForce(directionVector * Kamount, ForceMode.Impulse);
            //        
            //        this.gameObject.GetComponent<hitReceive>().isHit = false;
            //    }
            //    else
            //    {
            ...
            //        }
            //
            //        if (football && Input.GetKeyDown(KeyCode.N))
            //        {
            //            if (Vector3.Distance(this.transform.position, ballScript.gameObject.transform.position) < range)
            //            {
            //                ballScript.Shoot(1);
            //            }
            //            throwaLeg.Init(); 
            //        }
            //        else if (football && Input.GetKeyUp(KeyCode.N))
            //        {
            //            StartCoroutine(delayLeg());
            //        }
            //    }
            //
            //}
            ...
            //        }
            //
            //        if (football && Input.GetKeyDown(KeyCode.Keypad2))
            //        {
            //            if (Vector3.Distance(this.transform.position, ballScript.gameObject.transform.position) < range)
            //            {
            //                ballScript.Shoot(0);
            ...
            //            throwaLeg.Init();
            //        }
            //        else if (football && Input.GetKeyUp(KeyCode.Keypad2))
            //        {
            //            StartCoroutine(delayLeg());
            //        }
            //    }
